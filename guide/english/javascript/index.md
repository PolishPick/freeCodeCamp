...
Mozilla's SpiderMonkey (the first JavaScript engine ever written) is currently used in Mozilla Firefox.
V8 (Google's JavaScript engin) is used in Google Chrome.

Google Apps Script is a cloud-based/server-side interpreter that provides programmatic "macro-like" control of Google Apps services and documents.

Node.js (built on top of V8) is a platform which enables server-side applications to be written in JavaScript.
...
Mozilla also offers Rhino (an implementation of JavaScript built in Java) which is typically embedded into Java applications to provide scripting to end users.
